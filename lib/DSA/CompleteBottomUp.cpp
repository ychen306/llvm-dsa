...
INITIALIZE_PASS_BEGIN(CompleteBUDataStructures, "", "", true, true)
INITIALIZE_PASS_DEPENDENCY(BUDataStructures)
INITIALIZE_PASS_END(CompleteBUDataStructures, "", "", true, true)
