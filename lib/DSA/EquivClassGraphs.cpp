...
INITIALIZE_PASS_BEGIN(EquivBUDataStructures, "", "", true, true)
INITIALIZE_PASS_DEPENDENCY(CompleteBUDataStructures)
INITIALIZE_PASS_END(EquivBUDataStructures, "", "", true, true)
