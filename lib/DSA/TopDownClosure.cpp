...
INITIALIZE_PASS_BEGIN(TDDataStructures, "", "", true, true)
INITIALIZE_PASS_DEPENDENCY(EquivBUDataStructures)
INITIALIZE_PASS_END(TDDataStructures, "", "", true, true)


INITIALIZE_PASS_BEGIN(EQTDDataStructures, "", "", true, true)
INITIALIZE_PASS_DEPENDENCY(EquivBUDataStructures)
INITIALIZE_PASS_END(EQTDDataStructures, "", "", true, true)
